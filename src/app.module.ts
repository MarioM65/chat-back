...
@Module({
  imports: [],
  controllers: [ UsersController, UsersBloqueadosController, AuthController, ConversaController, ParticipanteConversaController, NotificacaoController, LeituraMensagemController],
  providers: [PrismaService, UserService, UserBloqueadoService, ConversaService, ParticipanteConversaService, NotificacaoService, LeituraMensagemService],
})
